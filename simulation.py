...
class Vehicle(pygame.sprite.Sprite):
    def __init__(self, lane, vehicleClass, direction_number, direction, will_turn):
        ...
        path = "simimages/" + direction + "/" + vehicleClass + ".png"
                ...
                if(self.crossed==0 or self.x+self.currentImage.get_rect().width<mid[self.direction]['x']):
                    ...
                    if(self.turned==0):
                        ...
                        if(self.rotateAngle==90):
                            self.turned = 1
                            # path = "simimages/" + directionNumbers[((self.direction_number+1)%noOfSignals)] + "/" + self.vehicleClass + ".png"
...
class Main:
    ...
    background = pygame.image.load('simimages/mod_int.png')

    screen = pygame.display.set_mode(screenSize)
    pygame.display.set_caption("SIMULATION")

    # Loading signal simimages and font
    redSignal = pygame.image.load('simimages/signals/red.png')
    yellowSignal = pygame.image.load('simimages/signals/yellow.png')
    greenSignal = pygame.image.load('simimages/signals/green.png')
